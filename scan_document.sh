...
ALEXANDRIA_HOLDING=/volumes/alexandria/pre-api-holding
TAGS_FILE=${ALEXANDRIA_HOLDING}/tags
...
cp $OUTPUT_DIR/$RESULT_NAME $ALEXANDRIA_HOLDING/
echo "${RESULT_NAME} ${TAGS}" >> TAGS_FILE
